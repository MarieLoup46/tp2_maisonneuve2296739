...
<div class="row">
        <div class="col-12 text-center pt-2">
            <h1 class="display-one">@lang('lang.text_add_student')</h1>
        </div>
    </div>
    <hr>
                ...
                @csrf
                    ...
                    <div class="card-body">   
                        ...
                        <div class="control-grup col-12 mb-3">
                            ...
                            <input type="date_naissance" id="date_naissance" name="date_naissance" placeholder="yyyy-mm-dd" class="form-control">
                        </div>
                    </div>
